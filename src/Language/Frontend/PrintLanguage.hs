...
instance Print Language.Frontend.AbsLanguage.Exp where
  prt i = \case
    Language.Frontend.AbsLanguage.EIf exp1 exp2 exp3 -> prPrec i 1 (concatD [doc (showString "if"), doc (showString "("), prt 1 exp1, doc (showString ")"), doc (showString "then"), prt 1 exp2, doc (showString "else"), prt 1 exp3])
    Language.Frontend.AbsLanguage.EAdd exp1 exp2 -> prPrec i 1 (concatD [prt 1 exp1, doc (showString "+"), prt 2 exp2])
    Language.Frontend.AbsLanguage.ESub exp1 exp2 -> prPrec i 1 (concatD [prt 1 exp1, doc (showString "-"), prt 2 exp2])
    Language.Frontend.AbsLanguage.EMul exp1 exp2 -> prPrec i 2 (concatD [prt 2 exp1, doc (showString "*"), prt 3 exp2])
    Language.Frontend.AbsLanguage.EDiv exp1 exp2 -> prPrec i 2 (concatD [prt 2 exp1, doc (showString "/"), prt 3 exp2])
